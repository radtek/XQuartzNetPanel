...
export class TriggerConfigurationStep extends Owner implements ConfigurationStep {
    ...
    constructor(
        ...
        this.validators.register(
            ...
            ValidatorsFactory.required('请输入cron表达式'));
        ...
        this.validators.register(
            ...
            ValidatorsFactory.required('请输入重复次数'),
            ValidatorsFactory.isInteger('请输入整数'));
        ...
        this.validators.register(
            ...
            ValidatorsFactory.required('请输入重复间隔'),
            ValidatorsFactory.isInteger('请输入整数'));
