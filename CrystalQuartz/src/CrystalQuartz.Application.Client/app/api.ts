...
export class ActivityStatus {
    static Active = new ActivityStatus(0, '活动中', 'active');
    static Paused = new ActivityStatus(1, '暂停的', 'paused');
    static Mixed = new ActivityStatus(2, '混合的', 'mixed');
    static Complete = new ActivityStatus(3, '完成的', 'complete');
